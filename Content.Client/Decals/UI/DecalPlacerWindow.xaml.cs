...
using Robust.Client.GameObjects; // LuaM
...
public sealed partial class DecalPlacerWindow : DefaultWindow
{
	...
	private readonly SpriteSystem _spriteSystem; // LuaM
    ...
    public DecalPlacerWindow()
    {
		...
		_spriteSystem = _e.System<SpriteSystem>(); // LuaM
...
//                _decals.Add(decalPrototype.ID, decalPrototype.Sprite.Frame0()); // Commented by LuaM
// LuaM-start:
            {
                var texture = _spriteSystem.Frame0(decalPrototype.Sprite);
                _decals.Add(decalPrototype.ID, texture);
            }
// LuaM-end.
        }
