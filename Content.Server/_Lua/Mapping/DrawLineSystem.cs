...
public sealed class DrawLineSystem : EntitySystem
{
	...
	[Dependency] private readonly SharedMapSystem _mapSystem = default!; // LuaM
    ...
    public void ToggleDrawForSession(ICommonSession session)
    {
        ...
        { originTile = _mapSystem.WorldToTile(grid.Value, g, mapPos); } // LuaM: g.WorldToTile(mapPos) > _mapSystem.WorldToTile(grid.Value, g, mapPos)
