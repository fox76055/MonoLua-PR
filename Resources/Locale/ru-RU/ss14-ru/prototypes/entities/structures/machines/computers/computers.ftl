...
ent-ComputerShuttle = консоль управления шаттлом
    .desc = Используется для пилотирования корабля.
ent-ComputerShuttleSyndie = консоль управления шаттлом Cиндиката
    .desc = Используется для пилотирования корабля Cиндиката.
...
ent-ComputerId = консоль ID-карт
    .desc = Компьютер для программирования ID-карт сотрудников вашей фракции или группировки, используемых для доступа к разным частям сектора.
