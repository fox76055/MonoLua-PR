    ...
    private void OnAppearanceChange(EntityUid uid, AirlockComponent comp, ref AppearanceChangeEvent args)
    {
            ...
            && powered)
        {
            ...
            unlitVisible =
				...
				|| (state == DoorState.Closed && comp.OpenUnlitVisible)) // LuaM: Port-airlocks-resprite
//                || (_appearanceSystem.TryGetData<bool>(uid, DoorVisuals.ClosedLights, out var closedLights, args.Component) && closedLights)) // Commented by LuaM: Port-airlocks-resprite
